...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'f4b92d7b-b48f-4bdf-b63f-23bac1c248cd' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('9dd56817-0816-46ab-af8f-0fea594abe1d');
      cy.get(`[data-cy="name"]`).should('have.value', '9dd56817-0816-46ab-af8f-0fea594abe1d');
